...
parser.add_argument('--dataset', default='./english_dataset_190623_new/', type=str)
parser.add_argument('--config', default='conf/intent_slot_jetson.yaml', type=str)
parser.add_argument('--exp-dir', default='./nemo_experiments_jetson', type=str) 
...
config.trainer.pop('checkpoint_callback', None)
# create trainer + model
trainer = pl.Trainer(**config.trainer, amp_backend='apex')
...
# example inference
queries = [
    'could you prepare a coffee one hours eleven minutes later',
    'would you shut down the lamp',
]
